...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#030014] text-slate-900 dark:text-slate-200 relative overflow-hidden flex items-center justify-center p-6 font-sans selection:bg-cyan-500/30 transition-colors duration-300">
      {/* 极光背景特效 */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[20%] left-[10%] w-[50%] h-[50%] rounded-full bg-cyan-100/20 dark:bg-cyan-900/10 blur-[150px] mix-blend-multiply dark:mix-blend-screen animate-[pulse_12s_ease-in-out_infinite]"></div>
        <div className="absolute bottom-[10%] right-[10%] w-[40%] h-[40%] rounded-full bg-purple-100/20 dark:bg-purple-900/10 blur-[150px] mix-blend-multiply dark:mix-blend-screen animate-[pulse_10s_ease-in-out_infinite_reverse]"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-lg dark:shadow-[0_0_20px_rgba(168,85,247,0.15)] mb-6 backdrop-blur-xl">
            <Network className="h-7 w-7 text-purple-600 dark:text-purple-400" />
          </div>
          <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-2">注册账号</h1>
          <p className="text-slate-500 dark:text-slate-400 font-light tracking-wide">加入 SimuView，开启您的 AI 模拟面试之旅</p>
        </div>
        ...
        <div className="rounded-[2rem] bg-white/80 dark:bg-white/[0.02] backdrop-blur-2xl border border-slate-200 dark:border-white/10 p-8 shadow-2xl dark:shadow-[0_32px_64px_rgba(0,0,0,0.4)] relative overflow-hidden">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-3">
              <Label htmlFor="email" className="text-slate-600 dark:text-slate-300 font-semibold text-xs uppercase tracking-widest ml-1">
                邮箱地址
              </Label>
              <div className="relative group">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-purple-500 dark:group-focus-within:text-purple-400 transition-colors" />
                <Input
                  id="email"
                  type="email"
                  placeholder="请输入您的邮箱"
            ...
            <div className="space-y-3">
              <Label htmlFor="password" className="text-slate-600 dark:text-slate-300 font-semibold text-xs uppercase tracking-widest ml-1">
                设置密码
              </Label>
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-blue-500 dark:group-focus-within:text-blue-400 transition-colors" />
                <Input
                  id="password"
                  ...
                  className="h-14 pl-12 pr-12 bg-slate-50 dark:bg-[#030014]/50 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 rounded-2xl focus:border-blue-500/50 focus:ring-blue-500/20 transition-all"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 text-center border-t border-slate-100 dark:border-white/5 pt-6">
            <p className="text-slate-500 text-sm font-light">
              ...
              <button 
                ...
                className="text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 font-bold tracking-wide transition-colors uppercase ml-1"
              >
                立即登录
              </button>
            </p>
