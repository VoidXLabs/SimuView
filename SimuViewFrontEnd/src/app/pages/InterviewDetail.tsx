      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="rounded-[2.5rem] bg-white dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 p-8 md:p-10 shadow-xl dark:shadow-2xl overflow-hidden relative transition-colors duration-300">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                ...
                <div className="flex flex-col items-center justify-center p-6 bg-slate-50 dark:bg-slate-900/50 rounded-3xl border border-slate-100 dark:border-white/5 shadow-inner min-w-[120px]">
                  ...
                  <span className="text-5xl font-black text-slate-900 dark:text-white">{report.score}</span>
            ...
            <div className="rounded-[2.5rem] bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-white/5 p-8 flex items-center justify-between group cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/40 transition-all shadow-sm">
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg">
                  <Brain className="w-8 h-8 text-white" />
                </div>
                <div>
                  <h3 className="text-slate-900 dark:text-white font-bold text-lg">Full Interview Transcript</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">Review every question and your answers in detail</p>
                </div>
              </div>
              <ChevronRight className="w-6 h-6 text-slate-400 dark:text-slate-600 group-hover:text-slate-900 dark:group-hover:text-white transition-colors" />
            </div>
          </div>

          {/* Sidebar */}
          <div className="space-y-6">
            <div className="rounded-[2rem] bg-white dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 p-6 space-y-6 transition-colors shadow-sm">
